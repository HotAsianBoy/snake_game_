"""Component 3 c - Displaying Messages"""
import time
...
while not quit_game:
    ...
    clock.tick(60)  # Sets the speed of which iteration of the game loop
...
pygame.display.update()
time.sleep(2)   # Sets the time for how many seconds until the program closes
pygame.quit()
quit()
