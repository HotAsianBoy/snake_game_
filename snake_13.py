"""Component 6 - Keeping track of the highest score"""
import time
...
def load_high_score():
    ...
    high_score_file = open("HI_score.txt", 'r')
...
def game_loop():
    ...
    print(f"high score test: {high_score}")
    while not quit_game:
        ...
        score = round(time.time() - start_time)     # Records time from start
        # of game
        ...
        clock.tick(speed)  # Sets the speed of which iteration of the game loop
